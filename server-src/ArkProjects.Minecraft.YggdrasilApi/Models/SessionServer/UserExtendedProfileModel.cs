...
{
    [JsonPropertyName("timestamp")] public required long Timestamp { get; set; }

    [JsonPropertyName("profileId")] public required Guid ProfileId { get; set; }

    [JsonPropertyName("profileName")] public required string ProfileName { get; set; }

    [JsonPropertyName("textures")] public required IReadOnlyDictionary<string, ProfileTextureModel> Textures { get; set; }

    public static UserExtendedProfileModel Map(UserProfileEntity profile)
    {
        Dictionary<string, ProfileTextureModel> textures = new();
